  ...
  <tbody>
    ...
    <tr>
      <td>
        ...
        <div>
          <strong>Cookies &amp; cookie banners</strong><br>
          <p class="mb-0 small">Does the ad network use persistent cookies that may require a <a href="#privacy">cookie banner</a>?</p>
        </div>
      </td>
      <td class="text-center">
